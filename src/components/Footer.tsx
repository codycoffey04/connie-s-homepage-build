        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 mb-12">
          ...
          <div>
            ...
            <div className="space-y-4 text-white/90">
              <a href="tel:2566012041" onClick={() => trackPhoneClick("Richard", "256-601-2041")} className="flex items-center gap-2 hover:text-white transition-colors">
                <Phone className="h-4 w-4 text-brand-red" />
                <span>Richard: 256-601-2041</span>
              </a>
              <a href="tel:2566302824" onClick={() => trackPhoneClick("Connie", "256-630-2824")} className="flex items-center gap-2 hover:text-white transition-colors">
                <Phone className="h-4 w-4 text-brand-red" />
                <span>Connie: 256-630-2824</span>
              </a>
              <a href="tel:2564400822" onClick={() => trackPhoneClick("Toni", "256-440-0822")} className="flex items-center gap-2 hover:text-white transition-colors">
                <Phone className="h-4 w-4 text-brand-red" />
