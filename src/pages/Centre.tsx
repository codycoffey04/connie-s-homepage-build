...
const Centre = () => {
  ...
  const faqs = [
    ...
    {
      question: "Do you serve Centre even though it's in Cherokee County, not DeKalb?",
      answer: "Yes, we fully serve Centre and all of Cherokee County. While our office is located in Fort Payne at 2700 Jordan Rd SW, Centre is only about 25-30 minutes away, and we regularly post bonds at Cherokee County Detention Center at 110 Cedar Bluff Rd in Centre. Cherokee County has its own jail and court system separate from DeKalb County, but the bail bond process works the same way. When someone is arrested in Centre, they're booked at Cherokee County Jail, and we can post bond there just as quickly as we do in DeKalb. We've built relationships with Cherokee County jail staff over the years and know their procedures well. Whether your loved one is in DeKalb County Jail or Cherokee County Detention Center, call Richard at 256-601-2041, Connie at 256-630-2824, or Toni at 256-440-0822 and we'll handle everything."
    },
    {
      question: "What's different about bailing someone out of Cherokee County Jail versus DeKalb?",
      answer: "The core process is identical—you pay a 10% premium, we post the bond, and your loved one is released—but there are some logistical differences. Cherokee County Detention Center is located at 110 Cedar Bluff Rd in Centre, separate from DeKalb County Jail in Fort Payne. Court appearances will be at Cherokee County Courthouse at 100 Main St in Centre, not DeKalb County Courthouse. Release times at Cherokee County Jail typically run 2-10 hours depending on staffing and jail activity, compared to 1-8 hours at DeKalb. Cherokee County may have slightly different procedures for property bonds, often requiring involvement from a licensed bondsman. The fees are the same statewide—10% premium mandated by Alabama law plus state fees. From your perspective as the family member, everything feels the same: you call us, we explain the costs, you complete paperwork and payment, and we post the bond. We handle the county-specific details so you don't have to worry about them."
    },
    {
      question: "What information do I need when calling about someone arrested in Centre?",
      answer: "Have the defendant's full legal name and date of birth ready so we can locate them in Cherokee County's system. Knowing the charges helps us estimate bail, though we can verify the exact amount by contacting the jail. Since Centre arrests are processed at Cherokee County Detention Center, confirm they've been there long enough for booking to complete—typically 1-3 hours after arrival. Have your own valid ID available for signing the cosigner agreement and decide on your payment method. If you're unsure about any details, call us anyway. We'll contact Cherokee County Jail directly at 256-927-3365 to verify information, check booking status, and confirm the bail amount. We'll explain exactly what the total cost will be before you commit. Many families call feeling overwhelmed, and that's completely normal. We'll walk you through everything step by step and answer all your questions. The sooner you call, the sooner we start working on release."
    },
    {
      question: "What happens if someone I bailed out of Cherokee County Jail misses court?",
      answer: "The consequences are the same as in any Alabama county—a bench warrant is issued immediately and the bond enters forfeiture. As the cosigner, you become liable for the entire bail amount, not just the 10% premium. Court appearances for Cherokee County cases are held at Cherokee County Courthouse at 100 Main St in Centre, and missing any scheduled hearing triggers forfeiture. Alabama law provides approximately 90 days for the defendant to be located and returned before forfeiture becomes final. During this period, we'll contact you for any information about their whereabouts. If they're found and returned within the grace period, the court may set aside the forfeiture. If not, you owe the full bail amount plus recovery costs. The bonding company can garnish up to 25% of your wages, seize pledged collateral, and file civil lawsuits. Before cosigning, make absolutely sure this person will honor every court date. Stay in contact with them after release and remind them of all upcoming hearings at the Cherokee County Courthouse."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <QuickAnswers city="Centre" county="Cherokee County" releaseTime="2-10 Hours" />
        ...
        <div className="text-center mt-8 space-y-4">
          ...
          <div className="pt-4 border-t border-border/50">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link to="/bail-bonds-guide/cherokee-county-jail-guide" className="text-primary hover:text-primary/80 transition-colors font-medium">
                Cherokee County Jail Guide
              </Link>
