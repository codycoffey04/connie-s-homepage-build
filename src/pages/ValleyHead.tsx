...
const ValleyHead = () => {
  ...
  const faqs = [
    {
      question: "How much does a bail bond cost in Valley Head?",
    ...
    {
      question: "How long does release take from DeKalb County Jail for Valley Head arrests?",
    ...
    {
      question: "Do you serve Valley Head 24/7?",
      answer: "Yes. Richard, Connie, or Toni will answer your call at any time—even at 3 AM on Christmas morning. We're located in Fort Payne right next to the detention center and can respond quickly to Valley Head arrests."
    },
    {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section 
        ...
        style={{ backgroundImage: `url(${valleyHeadHeroBg})` }}
      >
        ...
        <div className="relative container mx-auto px-4 md:px-6 max-w-7xl z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl mb-10 text-white/90 max-w-xl">
              Fast, licensed bail bond agents serving Valley Head and DeKalb County. Close to your community and ready to help you navigate the system 24/7.
            </p>
          </div>
        </div>
      ...
      <Section className="quick-answers bg-gradient-to-b from-black to-gray-900 py-16 border-t-4 border-brand-red">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <Card className="bg-white border-2 border-transparent hover:border-brand-red transition-all overflow-hidden">
                <CardContent className="p-0">
                  <div className="relative h-48 overflow-hidden">
                    <img src={paymentMethods} alt="Flexible bail bond payment methods in Valley Head Alabama including credit cards and payment plans" className="w-full h-full object-cover" width="800" height="600" loading="lazy" fetchPriority="low" />
            ...
            {/* HOW FAST? Card - Valley Head Specific */}
            <AnimatedCard index={1}>
              <Card className="bg-white border-2 border-transparent hover:border-brand-red transition-all overflow-hidden">
                <CardContent className="p-0">
                  <div className="relative h-48 overflow-hidden">
                    <img src={howFastLightning} alt="Fast 2-8 hour bail bond release times in Valley Head DeKalb County Alabama" className="w-full h-full object-cover" width="800" height="600" loading="lazy" fetchPriority="low" />
                    <div className="absolute inset-0 bg-black/40"></div>
                  </div>
                  <div className="p-8 text-center">
            ...
            <AnimatedCard index={2}>
              <Card className="bg-white border-2 border-transparent hover:border-brand-red transition-all overflow-hidden">
                <CardContent className="p-0">
                  <div className="relative h-48 overflow-hidden">
                    <img src={clockImage} alt="24/7 emergency bail bonds available around the clock in Valley Head Alabama" className="w-full h-full object-cover" width="800" height="600" loading="lazy" fetchPriority="low" />
                    <div className="absolute inset-0 bg-black/40"></div>
                  </div>
                  <div className="p-8 text-center">
      ...
      {/* How to Get to Our Office from Valley Head */}
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="relative w-full h-[400px] rounded-lg overflow-hidden shadow-lg border-4 border-primary/20">
              <iframe
                ...
                title="Directions from Valley Head to Connie's Bail Bonding Office"
              />
            </div>
              ...
              <Card className="border-2 border-primary">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3 text-foreground/80">
                    <p><strong>Distance:</strong> 15 miles from Valley Head</p>
                    <p><strong>Route:</strong> Take Highway 117 to Highway 35, then to Fort Payne</p>
                  ...
                  <a
                    href="https://www.google.com/maps/dir/?api=1&origin=Valley+Head+AL&destination=2700+Jordan+Rd+SW,Fort+Payne,AL+35967"
                    target="_blank"
                  ...
                  >
                    ...
                    Get Directions from Valley Head
                  </a>
                </CardContent>
              </Card>
            </div>
