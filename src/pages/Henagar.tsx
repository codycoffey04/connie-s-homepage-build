      ...
      <Section className="pt-32 pb-20 bg-gradient-to-b from-primary/5 to-background">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-foreground">
            Henagar Bail Bonds — 24/7 DeKalb County Service
          </h1>
          <p className="text-xl md:text-2xl text-muted-foreground mb-8">
            Fast, Licensed Bail Bond Agents Serving Henagar and DeKalb County
          </p>
      ...
      <Section variant="muted">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-foreground/80 leading-relaxed">
            If your loved one has been arrested in Henagar, Connie's Bail Bonding is here to help. We've been serving Henagar families since 2019 with fast, compassionate bail bond service that you can count on—24 hours a day, 7 days a week.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-sm text-foreground/80">
                Licensed Alabama Bail Bond Agents serving Henagar and all of DeKalb County since 2019.
              </p>
            </div>
          </div>
